...
export class GuessesTableHandle<TableName extends string> implements __TableHandle<TableName> {
  ...
  tableCache: __TableCache<Guesses>;

  constructor(tableCache: __TableCache<Guesses>) {
  ...
  guessId = {
    ...
    find: (col_val: bigint): Guesses | undefined => {
  ...
  onInsert = (cb: (ctx: EventContext, row: Guesses) => void) => {
    return this.tableCache.onInsert(cb);
  }

  removeOnInsert = (cb: (ctx: EventContext, row: Guesses) => void) => {
    return this.tableCache.removeOnInsert(cb);
  }

  onDelete = (cb: (ctx: EventContext, row: Guesses) => void) => {
    return this.tableCache.onDelete(cb);
  }

  removeOnDelete = (cb: (ctx: EventContext, row: Guesses) => void) => {
    return this.tableCache.removeOnDelete(cb);
  }

  // Updates are only defined for tables with primary keys.
  onUpdate = (cb: (ctx: EventContext, oldRow: Guesses, newRow: Guesses) => void) => {
    return this.tableCache.onUpdate(cb);
  }

  removeOnUpdate = (cb: (ctx: EventContext, onRow: Guesses, newRow: Guesses) => void) => {
