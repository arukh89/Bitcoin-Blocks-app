...
export const SavePrizeConfig = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: SavePrizeConfig): void {
    __AlgebraicTypeValue.serializeValue(writer, SavePrizeConfig.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): SavePrizeConfig {
    return __AlgebraicTypeValue.deserializeValue(reader, SavePrizeConfig.getTypeScriptAlgebraicType());
  },

}

export default SavePrizeConfig;
